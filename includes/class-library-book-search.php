...
class Library_Book_Search {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_admin, 'register_book_taxonomies' );
		$this->loader->add_action( 'add_meta_boxes', $plugin_admin, 'register_book_meta_fields' );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_shortcode( 'library-books', $plugin_public, 'library_books_shortcode');
